...
export function TypographyH1({ children, className }: TypographyProps) {
  return (
    <h1
      className={cn(
        "scroll-m-20 text-4xl font-semibold tracking-tighter text-balance md:text-5xl lg:text-7xl",
        className
      )}
    >
      {children}
...
export function TypographyH2({ children, className }: TypographyProps) {
  return (
    <h2
      className={cn(
        "scroll-m-20 pb-2 text-3xl font-semibold tracking-tight first:mt-0 md:text-4xl lg:text-6xl",
        className
      )}
    >
      {children}
...
export function TypographyH3({ children, className }: TypographyProps) {
  return (
    <h3
      className={cn(
        "scroll-m-20 text-2xl font-semibold tracking-tight md:text-3xl lg:text-5xl",
        className
      )}
    >
      {children}
